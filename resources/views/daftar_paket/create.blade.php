...
@error('nama_paket') is-invalid @enderror" id="nama_paket" placeholder="Tulis Nama Paket" name="nama_paket" value="{{old('nama_paket')}}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control
@error('paket_wisata') is-invalid @enderror" placeholder="Pilih Paket Wisata" id="paket_wisata" name="paket_wisata" value="{{old('paket_wisata')}}" arialabel="paket_wisata" aria-describedby="cari" readonly>
...
@error('jumlah_peserta') is-invalid @enderror" id="jumlah_peserta" placeholder="Masukan Jumlah Pesrta" name="jumlah_peserta" value="{{old('jumlah_peserta')}}">
                            @error('jumlah_peserta') <span class="text-danger">{{$message}}</span> @enderror
                        </div>
                        <div class="form-group">
                            <label for="harga_paket">Harga Paket</label>
                            <input type="number" class="form-control
@error('harga_paket') is-invalid @enderror" id="harga_paket" placeholder="Masukan Harga Paket" name="harga_paket" value="{{old('harga_paket')}}">
