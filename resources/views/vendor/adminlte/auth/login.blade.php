...
@section('auth_header', __('Sign in akun mu yang sudah terdaftar di LaTravel'))
...
<form action="{{ $login_url }}" method="post">
    ...
    <div class="row">
        ...
        <div class="col-5">
            <button type=submit class="btn btn-block-olive {{ config('adminlte.classes_auth_btn', 'btn-flat btn-primary') }}">
...
<p class="my-0">
    <a href="{{ $register_url }}">
        {{ __('Tekan ini jika kamu belum daftar di LaTravel sebelumnya!') }}
    </a>
</p>
@endif
@stop